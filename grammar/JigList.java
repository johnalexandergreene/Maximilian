 ...
 */
public class JigList extends ArrayList<Jig> implements Maximilian{
   ...
   */
  public List<Jig> getJigsAboveDetailSizeFloor(MPolygon target,double floor){
  ...
  public List<Jig> getJigsAboveDetailSizeFloorWithTags(MPolygon target,double floor,String[] tags){
    List<Jig> 

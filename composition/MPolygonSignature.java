 ...
 */
public class MPolygonSignature implements Serializable{
  ...
  public MPolygonSignature(MPolygon p){
    MPolygon node=p;
    while(node!=null){
  ...
  public static class SigComponent implements Serializable{
    ...
    public SigComponent(MPolygon p){
      metagon=p.metagon;
  ...
  public boolean equals(Object a){
    MPolygonSignature s0=(MPolygonSignature)a;
